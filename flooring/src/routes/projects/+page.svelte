<div class="w-full h-full py-20 flex flex-col justify-center place-items-center dark:bg-black">
    <div class="w-full max-w-screen-2xl min-h-screen max-h-fit flex flex-col p-5 md:p-10 gap-10">
        <div class="h-screen w-full flex flex-col gap-10">
            ...
            <a href="/projects/premier-tower" class="text-base rounded-lg px-10 btn btn-sm text-white   place-self-start bg-[#091426] ">See More</a>
        </div>
        <div class="h-screen w-full flex flex-col gap-10">
            ...
            <a href="/projects/west-side-place" class="text-base rounded-lg px-10 btn btn-sm text-white  place-self-start bg-[#091426] ">See More</a>
